...
%         disList =[];
    ...
    hdg1 = str2double(currentGeometry.Attributes.hdg);
    ...
    for m =1:tempLen2
        ...
        if str2double(currentlaneSection.Attributes.s) == s1
    ...
    line(ax,[pointX Roadx+offset*cos(hdg1-pi/2)],[pointY Roady+offset*sin(hdg1-pi/2)],'linestyle','--');
